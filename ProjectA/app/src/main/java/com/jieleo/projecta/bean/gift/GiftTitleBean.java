...
public class GiftTitleBean implements Parcelable{
    ...
    protected GiftTitleBean(Parcel in) {
        code = in.readInt();
        message = in.readString();
    }

    public static final Creator<GiftTitleBean> CREATOR = new Creator<GiftTitleBean>() {
        @Override
        public GiftTitleBean createFromParcel(Parcel in) {
            return new GiftTitleBean(in);
        }

        @Override
        public GiftTitleBean[] newArray(int size) {
            return new GiftTitleBean[size];
        }
    };
